...
description: "How Buildmarkets uses client_order_id to make order requests idempotent so timed-out retries return the existing order instead of duplicating it."
---

...
description: "Introduces the core concepts, data model, and conventions used throughout the Buildmarkets API, including partners, accounts, orders, and webhooks."
---
